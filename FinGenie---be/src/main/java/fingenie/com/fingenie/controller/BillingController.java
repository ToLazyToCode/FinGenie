...
public class BillingController {
    ...
    @Operation(summary = "Create a payment order and gateway checkout URL")
    ...
    @Operation(summary = "VNPay return URL (display only, no subscription activation)")
    ...
    @Operation(summary = "VNPay IPN - source of truth for final payment confirmation")
