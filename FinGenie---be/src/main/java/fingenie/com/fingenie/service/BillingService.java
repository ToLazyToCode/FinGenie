...
public class BillingService {
    ...
    public BillingCheckoutResponse createCheckout(
        ...
        ensureDefaultPlans();
        if (request == null || isBlank(request.getPlanCode()) || request.getGateway() == null) {
        ...
        BillingGatewayService gatewayService = resolveGatewayService(request.getGateway());
        ...
        try {
            ...
            log.error("Checkout init failed gateway={} orderCode={}", request.getGateway(), order.getOrderCode(), ex);
